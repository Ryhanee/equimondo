    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-container">
          <h1 class="mb-0 pb-0 display-4" id="title">Bienvenue dans votre application Equimondo</h1>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12 col-lg-6">
        ...
        <div class="d-flex">
          ...
          <h2 class="small-title">Votre activitÈ de la journÈe</h2>
        </div>
        ...
        <div class="mb-5">
          <div class="row g-2">
            ...
            if($_SESSION['connind'] == "util")
              {
                $req1 = 'SELECT count(calenum),calecatelibe,calecatenum FROM calendrier,calendrier_categorie WHERE calendrier_categorie_calecatenum = calecatenum AND calendrier.AA_equimondo_hebeappnum = "'.$_SESSION['hebeappnum'].'" AND caledate1 BETWEEN "'.date('Y-m-d').' 00:00:00" AND "'.date('Y-m-d').' 23:59:59" GROUP BY calecatenum ORDER BY calecatelibe ASC';
                $req1Result = $ConnexionBdd ->query($req1) or die ('Erreur SQL !'.$req1.'<br />'.mysqli_error());
            		while($req1Affich = $req1Result->fetch())
            			{
                    echo "<a href='".$Dossier."modules/calendrier/modcalelist.php?calecatenum=".$req1Affich[2]."'><div class='col-12 col-sm-6 col-lg-6'>
                          ...
                          <div class='col'>
                            <div class='row gx-2 d-flex align-content-center'>
                              <div class='col-12 col-xl d-flex'>
                                <div class='d-flex align-items-center lh-1-25'>".$req1Affich[1]."</div>
                              </div>
                              <div class='col-12 col-xl-auto'>
                                <div class='cta-2 text-primary'>".$req1Affich[0]."</div>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            if($_SESSION['connind'] == "clie")
              {
                // HEURE ¿ LAQUELLE LE CAVALIER VA MONTER AUJOURD 'HUI'
                $req1 = 'SELECT count(calenum) FROM calendrier,calendrier_categorie,calendrier_participants WHERE calendrier_calenum = calenum AND calendrier_categorie_calecatenum = calecatenum AND calendrier.AA_equimondo_hebeappnum = "'.$_SESSION['hebeappnum'].'" AND calendrier_participants.clients_clienum = "'.$_SESSION['connauthnum'].'" AND caledate1 BETWEEN "'.date('Y-m-d').' 00:00:00" AND "'.date('Y-m-d').' 23:59:59" AND (calecatetype = "1" OR calecatetype = "2" OR calecatetype = "3")';
                $req1Result = $ConnexionBdd ->query($req1) or die ('Erreur SQL !'.$req1.'<br />'.mysqli_error());
                    ...
                    echo "<div class='col-12 col-sm-6 col-lg-6'>
                      <div class='card sh-11 hover-scale-up cursor-pointer'>
                        <div class='h-100 row g-0 card-body align-items-center py-3'>
                          ...
                          <div class='col'>";
                          $req1 = 'SELECT calenum,calecatenum,calendrier_participants.chevaux_chevnum,calecatetype FROM calendrier,calendrier_categorie,calendrier_participants WHERE calendrier_calenum = calenum AND calendrier_categorie_calecatenum = calecatenum AND calendrier.AA_equimondo_hebeappnum = "'.$_SESSION['hebeappnum'].'" AND calendrier_participants.clients_clienum = "'.$_SESSION['connauthnum'].'" AND caledate1 BETWEEN "'.date('Y-m-d').' 00:00:00" AND "'.date('Y-m-d').' 23:59:59" AND (calecatetype = "1" OR calecatetype = "2" OR calecatetype = "3") ORDER BY caledate1 ASC';
                          $req1Result = $ConnexionBdd ->query($req1) or die ('Erreur SQL !'.$req1.'<br />'.mysqli_error());
                      		while($req1Affich = $req1Result->fetch())
                            {
                              echo "<a href='".$Dossier."modules/calendrier/caleajou.php?calenum=".$req1Affich['calenum']."'><div class='row gx-2 d-flex align-content-center'>
                                <div class='col-12 col-xl d-flex'>
                                  <div class='d-flex align-items-center lh-1-25'>".ReprisePresenceLect($req1Affich['calecatetype'])." - ".ChevLect($req1Affich[2],$ConnexionBdd)."</div>
                                </div>
                                <div class='col-12 col-xl-auto'>
                                  <div class='cta-2 text-primary'>".FormatDateTimeMySql($req1Affich['caledate1'])."</div>
                                </div>
                              </div></a>";
                            }
          ...
          <div class="scroll-by-count" data-count="8">
            ...
            <div class="card mb-2 sh-10 sh-md-8">
              <div class="card-body pt-0 pb-0 h-100">
                <div class="row g-0 h-100 align-content-center">
                  <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                    <a href="Pages.Portfolio.Detail.html" class="body-link text-truncate">Cholerm√ºs</a>
                  </div>
                  <div class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
            ...
            <div class="card mb-2 sh-10 sh-md-8">
              <div class="card-body pt-0 pb-0 h-100">
                <div class="row g-0 h-100 align-content-center">
                  <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                    <a href="Pages.Portfolio.Detail.html" class="body-link text-truncate">Ruisreik√§leip√§</a>
                  </div>
                  <div class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                    <span class="badge bg-outline-primary me-1">SALE</span>
                  </div>
